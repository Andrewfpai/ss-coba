        ...
        {props.faq.map((item, index) => (
          <div key={index} className="title-container mt-[1.21em]">
            ...
            <label className="title gap-[1.07em] pt-[2.71em] pb-[1.5em] flex items-center" htmlFor={"title-btn" + index}>
              ...
              <div className="w-[90%] text-[#503129]">{item?.pertanyaan}</div>
            ...
            <div className="text bg-[#E7E7E7] rounded-[15px] font-semibold text-[#503129]">
            <PortableTextRenderer className='px-7 py-5' value={item?.jawaban} />
